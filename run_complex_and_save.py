...
class ExperimentHarness:
    def __init__(self, data_generator: Callable, epochs: int = 50, batch_size: int = 32, save_path: str = 'complex_model.pt'):
    ...
    def run_trial(self, seed: int):
        ...
        # KEY ADDITION: Save the trained model's state dictionary
...
if __name__ == "__main__":
    ...
    harness = ExperimentHarness(data_generator, epochs=50, save_path='complex_model.pt')
