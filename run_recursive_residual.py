...
# Import the new, recursive residual model
from paradox_net_recursive_residual import ParadoxNetRecursiveResidual
...
class ParadoxNetText(nn.Module):
    """Wrapper for the new recursive residual model."""
    def __init__(self, sequence_length, vocab_size, embedding_dim=16, hidden_dims=[64, 32], penultimate_dim=32, n_patterns=8, temporal_lr=0.1, temp_lr=0.1):
        ...
        self.ppn = ParadoxNetRecursiveResidual(
...
# --- Model Factory ---
def create_recursive_residual_net(sequence_length, vocab_size, **kwargs):
...
class ExperimentHarness:
    ...
    def run_trial(self, seed: int):
        ...
        print("Starting training for the Recursive Residual Paradox Net...")
...
if __name__ == "__main__":
    ...
    model_factory = create_recursive_residual_net
