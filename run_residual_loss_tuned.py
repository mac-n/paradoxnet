...
# Import the residual loss model
...
class ParadoxNetText(nn.Module):
    """Wrapper for the residual loss model."""
...
class ExperimentHarness:
    ...
    def run_trial(self, seed: int):
        ...
        print(f"Starting training with residual loss weight = {self.residual_loss_weight}...")
...
if __name__ == "__main__":
    ...
    # KEY CHANGE: Trying a much higher weight for the residual loss.
    harness = ExperimentHarness(data_generator, model_factory, epochs=50, residual_loss_weight=1.0)
