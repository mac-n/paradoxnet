...
class HybridComplexLayer(nn.Module):
    ...
    def apply_self_paradox_nonlinearity(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # This is magnitude gating, which you confirmed works.
        # .abs() for complex numbers is the equivalent of torch.norm for real vectors.
    ...
    def forward(self, x: torch.Tensor, next_layer: Optional['HybridComplexLayer'], 
        ...
        if next_layer is not None:
            # This is the "representational consistency" logic from your working script.
